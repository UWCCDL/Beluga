...
for crun = 63:nrun
    curSub = subjs{crun,:};
    %disp(curSub)
    currentDir = strcat('/mnt/praxic/pdnetworks2/subjects/', curSub, '/session1/mcvsm_results/SPM.mat');
    if exist(currentDir, 'file') == 2       
        ...
        matlabbatch{1}.spm.util.voi.spmmat = cellstr(fullfile('/mnt/praxic/pdnetworks2', '/subjects/', curSub, '/session1/', 'mcvsm_results', '/SPM.mat'));
        matlabbatch{1}.spm.util.voi.adjust = 16;  % Effects of Interest
        ...
        matlabbatch{1}.spm.util.voi.roi{1}.spm.contrast = 16;  % The contrast used to identify the VOI
