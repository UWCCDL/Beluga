...
for crun = 39
    curSub = subjs{crun,:};
    %disp(curSub)
    currentDir = strcat('/mnt/praxic/pdnetworks2/subjects/', curSub, '/session1/mcvsa_results/SPM.mat');
    if exist(currentDir, 'file') == 2       
        ...
        matlabbatch{1}.spm.util.voi.spmmat = cellstr(fullfile('/mnt/praxic/pdnetworks2', '/subjects/', curSub, '/session1/', 'mcvsa_results', '/SPM.mat'));
        matlabbatch{1}.spm.util.voi.adjust = 10;  % Effects of Interest
        ...
        matlabbatch{1}.spm.util.voi.roi{1}.spm.contrast = 10;  % The contrast used to identify the VOI
